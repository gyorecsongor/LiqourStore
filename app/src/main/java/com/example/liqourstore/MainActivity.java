    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d(LOG_TAG, "firebaseAuthWithGoogle:" + Objects.requireNonNull(account).getId());
    ...
    public void login(View view) {
        ...
        mAuth.signInWithEmailAndPassword(userName, password).addOnCompleteListener(this, task -> {
            if(task.isSuccessful()){
                ...
                Toast.makeText(MainActivity.this, "User log in fail: " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
