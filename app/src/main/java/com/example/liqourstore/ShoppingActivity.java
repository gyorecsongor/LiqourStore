...
public class ShoppingActivity extends AppCompatActivity {
    ...
    private ArrayList<Liqours> mItemsData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ShoppingAdapter(this, mItemsData);
        ...
        mItems.orderBy("cartedCount", Query.Direction.DESCENDING).limit(itemLimit).get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                        Liqours item = document.toObject(Liqours.class);
    ...
    public void deleteItem(Liqours item) {
        DocumentReference ref = mItems.document(item._getId());
        ref.delete()
                .addOnSuccessListener(success -> Log.d(LOG_TAG, "Item is successfully deleted: " + item._getId()))
                .addOnFailureListener(fail -> Toast.makeText(this, "Item " + item._getId() + " cannot be deleted.", Toast.LENGTH_LONG).show());
    ...
    public void updateAlertIcon(Liqours item) {
        ...
        mItems.document(item._getId()).update("cartedCount", item.getCartedCount() + 1)
                .addOnFailureListener(fail -> Toast.makeText(this, "Item " + item._getId() + " cannot be changed.", Toast.LENGTH_LONG).show());
